...
print(board)
move = input("Choose your first move (upper left, upper center, upper right, middle left, center, middle right, lower left, lower center, lower right): ")
...
while not game_over:
  ...
  move = input(f"{board.turn}'s turn. Choose your next move: ")
